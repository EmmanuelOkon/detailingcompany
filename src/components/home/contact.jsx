  ...
  return (
    <div className="bg-mainBlack ">
      <div className="lg:max-w-7xl 2xl:max-w-[1560px] mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <h2 className="text-yellow text-[55px] pb-16 ">get in touch</h2>
        <div className="grid sm:grid sm:grid-cols-2 lg:gap-8 rounded-3xl lg:grid-cols-2">
          <div className="b lg:p-10  p-4 rounded-b-xl  sm:rounded-r-2xl">
          ...
          <div className=" flex flex-col justify-between py-6 px-4">
            <div className="">
              <ul className="text-center flex flex-col justify-center  md:bloc text-white">
                {contact.map((item) => (
                  <span
                    key={item.name}
                    className="flex flex-col justify-center md:justify-start md:w-full my-3 items-center px-4 md:px-0 md:flex-row md:text-left md:items-center text-[22px] "
                  >
